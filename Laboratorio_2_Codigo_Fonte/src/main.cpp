...
int main()
{
    ...
    GLFWwindow *window;
    window = glfwCreateWindow(800, 800, "INF01047 - 323915 - João Pedro Lopes Bazotti", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        c=Matrix_Translate(-carForward.x*10,-carForward.y*10,-carForward.z*10)*carPos;
        if (wPressed)
        {
            //c += -w * speed * delta_t;
        }
        ...
        glm::vec4 camera_position_c = c; // Ponto "c", centro da câmera
        ...
        else
        {
            ...
            float t = 1.5f * norm(c - origin) / 2.5f;
            float b = -t;
        ...
        TextRendering_PrintString(window, "Curva de grau 4 gerada aleatoriamente", -1.0f, 1.0f-pad, 1.0f);
