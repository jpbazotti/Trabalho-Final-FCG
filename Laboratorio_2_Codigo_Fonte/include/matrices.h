...
{
    return Matrix(
        //  AQUI A MATRIZ DE TRANSLAÇÃO (3D) EM COORD. HOMOGÊNEAS
...
{
    return Matrix(
        //  AQUI A MATRIZ DE ESCALAMENTO (3D) EM COORD. HOMOGÊNEAS
...
glm::mat4 Matrix_Rotate_X(float angle)
{
    ...
    float s = sin(angle);
    return Matrix(
        //  AQUI A MATRIZ DE ROTAÇÃO (3D) EM TORNO DO EIXO X EM COORD.
...
glm::mat4 Matrix_Rotate_Y(float angle)
{
    ...
    float s = sin(angle);
    return Matrix(
        //  AQUI A MATRIZ DE ROTAÇÃO (3D) EM TORNO DO EIXO Y EM COORD.
        // HOMOGÊNEAS, UTILIZANDO OS PARÂMETROS c e s
...
glm::mat4 Matrix_Rotate_Z(float angle)
{
    ...
    float s = sin(angle);
    return Matrix(
        //  AQUI A MATRIZ DE ROTAÇÃO (3D) EM TORNO DO EIXO Z EM COORD.
        // HOMOGÊNEAS, UTILIZANDO OS PARÂMETROS c e s
...
glm::mat4 Matrix_Rotate(float angle, glm::vec4 axis)
{
    ...
    return Matrix(
        //  AQUI A MATRIZ DE ROTAÇÃO (3D) EM TORNO DO EIXO v EM COORD.
...
glm::mat4 Matrix_Camera_View(glm::vec4 position_c, glm::vec4 view_vector, glm::vec4 up_vector)
{
    ...
    return Matrix(
        // AQUI A MATRIZ DE MUDANÇA DE SISTEMA DE COORDENADAS (3D)
...
glm::mat4 Matrix_Perspective(float field_of_view, float aspect, float n, float f)
{
    ...
    float b = -t/*AQUI o parâmetro b */;
    float r = t * aspect;
    float l = -r/*AQUI o parâmetro l */;

    glm::mat4 P = Matrix(
        // AQUI A MATRIZ P DE PROJEÇÃO PERSPECTIVA (3D) UTILIZANDO OS
        // PARÂMETROS n e f.
